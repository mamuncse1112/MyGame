 ...
 * @author User
 */
public class FlappyBird2 implements ActionListener, KeyListener {
    ...
    public void go() {
        ...
        bird = new Bird();
      //  frame.getContentPane().setBackground(new Color(65,178,247));
        rects = new ArrayList<Rectangle>();
        panel = new GamePanel2(this, bird, rects);
        frame.add(panel);
...
//    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(!paused) {
            ...
            scroll++;
            if(scroll==2000){
                JOptionPane.showMessageDialog(null, "Level 3 Is Successfully Completed......");
                paused=true;
                new FlappyBird3().go();
            }
